...
GeometricSurfaceTypesVals={   '<HTML><table border=0 width=595 bgcolor=#CCECFE><TR><TD> Spherical </TD></TR> </table></HTML>',...
                          '<HTML><table border=0 width=595 bgcolor=#CCECFE><TR><TD> Parabaloidal </TD></TR> </table></HTML>',...
                          '<HTML><table border=0 width=595 bgcolor=#CCECFE><TR><TD> Ellipsoidal </TD></TR> </table></HTML>',...
                          '<HTML><table border=0 width=595 bgcolor=#CCECFE><TR><TD> Flat </TD></TR> </table></HTML>',...
                          '<HTML><table border=0 width=595 bgcolor=#CCECFE><TR><TD> Conus </TD></TR> </table></HTML>',...
                          '<HTML><table border=0 width=595 bgcolor=#CCECFE><TR><TD> Hyperbolic </TD></TR> </table></HTML>'
                      };
GeometricSurfaceTypesKeys = {'Spherical','Parabaloidal','Ellipsoidal','Flat','Conus','Hyperbolic'};

GlobalSet('GeometricSurfaceTypes',containers.Map(GeometricSurfaceTypesKeys,GeometricSurfaceTypesVals));

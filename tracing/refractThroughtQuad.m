...
rays_in=quadIntersect(quad_,rays_in);
    ...
    if strcmp(quad_.extraDataType,conusType())
        ref_point=quad_.position-(quad_.TBN*[0 0 quad_.extraData.C]')';
